...
public class ExcelParseService {
        ...
        public boolean parseExcel(Path outputPath, CreditRequest request) throws Exception {
                ...
                dataSheet.getRow(cr.getRow()).getCell(cr.getCol())
                                .setCellValue(request.getRequestedUser().getMaritalStatus() == "MARRIED" ? "Evli"
                                                : "Subay");
                ...
                if (request.getGuarantors() != null && request.getGuarantors().size() > 0) {
                        ...
                        dataSheet.getRow(cr.getRow()).getCell(cr.getCol())
                                        .setCellValue(request.getGuarantors().get(0).getEventDate() == null ? ""
                                                        : DATE_FORMAT.format(
                                                                        request.getGuarantors().get(0).getEventDate()));
                        cr = new CellReference("C106");
                        dataSheet.getRow(cr.getRow()).getCell(cr.getCol())
                                        .setCellValue(request.getGuarantors().get(0).getPersonAz().getName() + " " + request.getGuarantors().get(0).getPersonAz().getSurname() + " " + request.getGuarantors().get(0).getPersonAz().getPatronymic());
                        ...
                        if (request.getGuarantors().size() > 1) {
                                ...
                                dataSheet.getRow(cr.getRow()).getCell(cr.getCol())
                                                .setCellValue(request.getGuarantors().get(1).getEventDate() == null ? ""
                                                                : DATE_FORMAT.format(request.getGuarantors().get(1)
                                                                                .getEventDate()));
                                cr = new CellReference("C124");
                                dataSheet.getRow(cr.getRow()).getCell(cr.getCol())
                                                .setCellValue(request.getGuarantors().get(1).getPersonAz().getName() + " " + request.getGuarantors().get(1).getPersonAz().getSurname() + " " + request.getGuarantors().get(1).getPersonAz()
                                                                .getPatronymic());
