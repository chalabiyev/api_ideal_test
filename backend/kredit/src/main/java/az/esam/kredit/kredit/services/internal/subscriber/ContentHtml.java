...
import static az.esam.kredit.kredit.services.internal.subscriber.SubscribeServiceImpl.url;
...
public class ContentHtml {
    ...
    public static final String unSubscribeHtmlContent = "<!DOCTYPE html>" +
            "<html>" +
            "<head>" +
            "<style>" +
            "body {font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;}" +
            ...
            "<p>Fikrinizi dəyişsəniz, hər zaman <a href='" + url + "'>yenidən abunə ola bilərsiniz</a></p>" +
            "</div>" +
            "<div class='footer'>" +
            "© 2024 Wunderking. All rights reserved." +
            "</div>" +
