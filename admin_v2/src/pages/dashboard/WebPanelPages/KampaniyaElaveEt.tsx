...
const KampaniyaElaveEt = () => {
  const router = useRouter();
  const { postData: createCampaign, loading, error } = usePost('/content/campaign/create');
  ...
  const handleCreateCampaign = async () => {
    toast.promise(createCampaign(campaignFormData), {
      loading: 'Kampaniya yaradılır...',
...
export default KampaniyaElaveEt;
