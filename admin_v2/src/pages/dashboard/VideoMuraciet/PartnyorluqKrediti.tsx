...
import TabIdentificationPartner from 'src/components/partner/TabIdentificationPartner';
import TabAKBPartner from 'src/components/partner/TabAKBPartner';
...
import TabVideoRecordPartner from 'src/components/partner/TabVideoRecordPartner';
  ...
  return (
    <>
      ...
      <DashboardContent maxWidth="xl">
        <CustomBreadcrumbs
          heading="Partnyorluq krediti"
          links={[{ name: 'Video müraciət' }, { name: 'Partnyorluq krediti' }]}
          // action={
          //   <Button
        ...
        <Box sx={{ width: '100%', typography: 'body1' }}>
          <TabContext value={value}>
            ...
            <TabPanel sx={{ p: 0 }} value="2">
              <TabAKBPartner AKB_STATE={AKB_STATE} setAKB_STATE={setAKB_STATE} />
            </TabPanel>
            <TabPanel sx={{ p: 0 }} value="3">
              <RecruiterDataPartner
            ...
            <TabPanel sx={{ p: 0 }} value="7">
              <TabVehicleInformationPartner setValue={setValue} />
            </TabPanel>

            <TabPanel sx={{ p: 0 }} value="8">
              <TabCreditDataPagePartner
                setValue={setValue}
                creditRequest={creditRequest}
                setCreditRequest={setCreditRequest}
              />
