...
export const CONFIG: ConfigValue = {
  ...
  auth: {
    method: 'jwt',
    skip: false,
    redirectPath: paths.esassehife.statistika,
  },
  /**
   * APMapboxI
   */
...
export const ToastMessages = {
  success: {
    saveData: 'Məlumatlar yadda saxlanıldı',
  },
  error: {
    saveFailed: 'Məlumatlar yadda saxlanılmadı',
  },
  warning: {
    incompleteData: 'Zəhmət olmasa bütün məlumatları doldurun',
  },
  deleting: {
    loading: 'Məlumatlar silinir..',
    success: 'Məlumatlar silindi',
    error: 'Məlumatlar silinmədi',
  },
  limit: {
    error: 'Maksimum 3 məhsul əlavə edilə bilər',
  },
};
