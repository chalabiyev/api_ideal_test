import type { IGirovReview } from 'src/types/girov';
...
import { ProductReviewList } from './girov-review-list';
import { ProductReviewNewForm } from './girov-review-new-form';
