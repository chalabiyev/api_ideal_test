import type { IGirovFilters } from 'src/types/girov';
...
type Props = {
  ...
  onOpen: () => void;
  onClose: () => void;
  filters: UseSetStateReturn<IGirovFilters>;
  options: {
    colors: string[];
    ratings: string[];
    categories: string[];
...
export function GirovFilters({ open, onOpen, onClose, canReset, filters, options }: Props) {
...
type InputRangeProps = {
  type: 'min' | 'max';
  value: number[];
  onFilters: UseSetStateReturn<IGirovFilters>['setState'];
};
